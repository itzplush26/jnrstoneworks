  ...
  return (
    <main>
      <PageHero
        ...
        lead="Browse the curated HIMACS lineup and filter by tone, collection series, or color code to find the right surface faster."
        meta={["Real catalog swatches", "Tone + series filters", "Code reference tags"]}
        actions={
          <>
      ...
      <section className="section section--cream content-block">
        <div className="section__inner grid" style={{ gap: "1.2rem" }}>
          <p className="story-line">
            Swatches and codes are based on the official HIMACS catalog references. Actual
